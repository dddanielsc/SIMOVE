...
try
{
	...
	else if($_GET["action"] == "create")
	{
		...
		$result = mysql_query("INSERT INTO cartaoentrada (veiculo_codVeiculo, usuario_pessoa_codPessoa)
               VALUES VALUES('" . $_POST["InputVeiculo"] . "', " . $_POST["InputPessoa"] . ",now());");
