...
<html lang="pt-br">
    ...
    <body>
        ...
        <div>
            <ul class="breadcrumb">
                <span class="brand">SIMOVE | Painel do Administrador - </span> <?= $u->getUsuario(); echo " | " ?> 
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="div-padding imgLado">
                        <a href="#" id="gerPessoas"><img src="icons/pessoas.png" class="img-rounded"></a>
                        <br>
                        <label>Pessoas</label>
                    </div>
                    <div class="div-padding imgLado">
                        <a href="#" id="gerUsuarios"><img src="icons/ges_usuarios.png" class="img-rounded"></a>
                        <br>
                    ...
                    <div class="div-padding imgLado">
                        <a href="#" id="gerTags"><img src="icons/tag.png" class="img-rounded"></a>
                        <br>
                        <label>Visualizar Tags</label>
                    </div>  
                    <div class="div-padding imgLado">
                        <a href="#" id="gerMovimentacoes"><img src="icons/movimentacao.png" class="img-rounded"></a>
                        <br>
